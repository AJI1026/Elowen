...
const EN = {
  ...
  "tutorial.intro":
    "Select text or click a figure, then use the menu that appears:",
  ...
  "tos.p1":
    "Elowen is a research experiment that uses the Gemini API to annotate and answer questions about arXiv papers.",
  "tos.p1Link": "(see Gemini API Terms of Service)",
  "tos.p2":
    'All queries to the Gemini API, including freeform text sent through Elowen\'s "smart search" feature, will be logged anonymously, i.e., only the exact text you send—not other information such as location, browser, or device—will be stored. Please do not enter any sensitive or personal information into Elowen. If you would like to request that a query on Elowen be removed from storage, please contact',
  "tos.p2After":
    "and include the full text of that query (which can be found in your search history).",
  "tos.p3":
    'Your search history (including papers you click on and queries you make in "smart search") is kept in browser storage on your device and can be cleared at any time on the Settings page.',
  "tos.p4Before": "This demo was created by",
  "tos.p4Mid": "and follows Google's",
  "tos.p4Privacy": "Privacy Policy",
  "tos.p4After": ".",
...
const ZH: Record<MessageKey, string> = {
  ...
  "tutorial.intro": "选中文本或点击插图，会出现操作菜单：",
  ...
  "tos.p1":
    "Elowen 是一个研究型实验产品，使用 Gemini API 为 arXiv 论文添加标注并回答问题。",
  "tos.p1Link": "（查看 Gemini API 服务条款）",
  "tos.p2":
    "所有发往 Gemini API 的请求（包括通过 Elowen「智能搜索」发送的自由文本）都会被匿名记录，即仅保存你发送的原文，不会保存位置、浏览器或设备等信息。请勿在 Elowen 中输入敏感或个人信息。如需申请删除某条查询记录，请联系",
  "tos.p2After": "，并附上该查询的完整文本（可在搜索历史中找到）。",
  "tos.p3":
    "你的搜索历史（包括点击的论文与「智能搜索」查询）保存在本机浏览器存储中，可随时在设置页清除。",
  "tos.p4Before": "本演示由",
  "tos.p4Mid": "创建，并遵循 Google 的",
  "tos.p4Privacy": "隐私政策",
  "tos.p4After": "。",
