...
import { ElowenDoc } from "../../shared/elowen_doc";

class MockElowenDocManager extends ElowenDocManager {
  constructor(elowenDoc: any) {
    super(elowenDoc);
  }
}
...
describe("elowen-doc", () => {
  ...
  beforeEach(() => {
    ...
    elowenDocManager = new MockElowenDocManager(elowenDoc);
    collapseManager = new MockCollapseManager(elowenDocManager);
