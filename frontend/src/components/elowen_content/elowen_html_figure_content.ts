...
import { HtmlFigureContent } from "../../shared/elowen_doc";

import {
  preprocessHtmlForKatex,
  renderKatexInHtml,
} from "./elowen_html_figure_utils";

import { styles } from "./elowen_html_figure_content.scss";

/**
 * A component to render sanitized HTML content for figures like tables,
 * algorithms, etc.
 */
@customElement("elowen-html-figure-content")
export class ElowenHtmlFigureContent extends MobxLitElement {
  ...
  private renderCaption() {
    ...
    // Assumes a elowen-span component exists to render the caption.
    return html`
      <figcaption>
        <elowen-span .span=${this.content.caption}></elowen-span>
      </figcaption>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    "elowen-html-figure-content": ElowenHtmlFigureContent;
  }
}
