...
import { styles } from "./elowen_image.scss";
 ...
 * states.
 */
@customElement("elowen-image")
export class ElowenImage extends MobxLitElement {
  ...
  private renderError() {
    return html`<div class="image-error-placeholder">${t(
      "image.loadError",
