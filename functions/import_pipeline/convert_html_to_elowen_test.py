...
from import_pipeline import (
    convert_html_to_elowen,
    convert_elowen_spans,
...
class ConvertHtmlToElowenTest(unittest.TestCase):
    @patch.object(convert_elowen_spans, "get_unique_id", return_value="uid")
    @patch.object(convert_html_to_elowen, "get_unique_id", return_value="uid")
    def test_convert_raw_output_to_spans(
        ...
        with self.subTest("model output containing a tag"):
            ...
            actual_spans = convert_html_to_elowen.convert_raw_output_to_spans(
                model_output
            )

            expected_span = ElowenSpan(
                id="uid",
                text="Testing italic",
                inner_tags=[
                    InnerTag(
    ...
    def test_nested_headings(
        self, mock_get_unique_id_html_to_elowen, mock_get_unique_id_elowen_spans
    ):
        """Tests that headings are nested correctly into sub_sections."""
            ...
            ElowenSection(
                ...
                contents=[
                    ElowenContent(
                        ...
                        text_content=TextContent(
                            tag_name="p",
                            spans=[ElowenSpan(id="uid", text="Content 2", inner_tags=[])],
                        ),
                    )
                ],
                sub_sections=[],
        ...
        # Call convert_to_elowen_sections directly
        converted_sections = convert_html_to_elowen.convert_to_elowen_sections(
    ...
    @parameterized.expand(
        [
            ...
            (
                ...
                {
                    "[[ELOWEN_PLACEHOLDER_123]]": ElowenContent(
                        id="123",
                        image_content=ImageContent(
                            latex_path="fig1.png",
                            storage_path="file_id/images/fig1.png",
            ...
            (
                ...
                "<h1>heading</h1><p>Text before. [[ELOWEN_PLACEHOLDER_123]] Text after.</p>",
                [
                    ElowenSection(
                        id="123",
                        sub_sections=[],
            ...
            (
                ...
                "<ul><li>An equation [[ELOWEN_EQUATION_123]]</li></ul>",
                [
                    ElowenSection(
                        id="123",
                        sub_sections=[],
    ...
    def test_convert_to_elowen_sections(
        self,
        name,
        html,
        expected_sections,
        ...
        mock_get_unique_id_convert_html_to_elowen=None,
        mock_get_unique_id_convert_elowen_spans=None,
